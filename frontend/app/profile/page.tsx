      ...
      <div className="flex flex-col w-3/5 mx-auto mt-14">
        <div className="flex m-5 justify-between">
          <div className="flex flex-col">
            ...
            <span>You can update your profile here!</span>
          </div>
        ...
        <div className="flex flex-row m-5 justify-between">
          ...
          <Controller
            rules={{
              ...
              validate: {
                notEmpty: value =>
                  value.trim() !== '' || 'Username cannot be empty or contain only whitespace',
              },
            }}
            name="username"
            control={control}
        ...
        <div className="flex flex-row m-5 justify-between">
          <div className="flex flex-col">
            ...
            <p className="text-start text-sm font-medium md:text-base">This cannot be undone.</p>
          </div>
