  ...
  return (
    <>
      <div className="mx-auto px-6 max-w-7xl flex flex-col justify-center text-center my-12">
        ...
        {!inQueue && (
          <div>
            <p className="text-3xl font-extrabold my-6">
              Looking for a practice partner to conduct a mock interview?
            </p>
            ...
            <p className="text-xl my-6 text-red-500">
              (Note: Your solution will be auto saved after you leave the interview room.)
            </p>
          </div>
        )}
        {inQueue && (
          <div>
            ...
            <p className="text-2xl font-semibold my-6 text-teal-400">
